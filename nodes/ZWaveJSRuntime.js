...
const event_NodeFirmwareUpdateFinished = new SanitizedEventName('firmware update finished');
const event_NodeFirmwareUpdateProgress = new SanitizedEventName('firmware update progress');
